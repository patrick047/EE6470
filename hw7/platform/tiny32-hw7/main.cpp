...
public:
	...
	addr_t GaussianBlurFilter0_start_addr = 0x73000000;
	addr_t GaussianBlurFilter0_size = 0x01000000;
	addr_t GaussianBlurFilter0_end_addr = GaussianBlurFilter0_start_addr + GaussianBlurFilter0_size - 1;
	addr_t GaussianBlurFilter1_start_addr = 0x74000000;
	addr_t GaussianBlurFilter1_size = 0x01000000;
	addr_t GaussianBlurFilter1_end_addr = GaussianBlurFilter1_start_addr + GaussianBlurFilter1_size - 1;
	bool quiet = false;
	...
	void parse(int argc, char **argv) override {
		...
		assert((mem_end_addr < clint_start_addr || mem_start_addr > GaussianBlurFilter1_end_addr) &&
		       "RAM too big, would overlap memory");
		assert((mem_end_addr < clint_start_addr || mem_start_addr > GaussianBlurFilter2_end_addr) &&
		       "RAM too big, would overlap memory");
...
int sc_main(int argc, char **argv) {
	...
	GaussianBlurFilter GaussianBlurFilter0("GaussianBlurFilter0");
	GaussianBlurFilter GaussianBlurFilter1("GaussianBlurFilter1");
	...
	bus.ports[12] = new PortMapping(opt.GaussianBlurFilter0_start_addr, opt.GaussianBlurFilter0_end_addr);
	bus.ports[12] = new PortMapping(opt.GaussianBlurFilter1_start_addr, opt.GaussianBlurFilter1_end_addr);
	...
	bus.isocks[12].bind(GaussianBlurFilter0.tsock);
	bus.isocks[13].bind(GaussianBlurFilter1.tsock);
