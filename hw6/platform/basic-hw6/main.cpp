...
public:
	...
	addr_t GaussianBlurFilter_start_addr = 0x73000000;
	addr_t GaussianBlurFilter_size = 0x01000000;
	addr_t GaussianBlurFilter_end_addr = GaussianBlurFilter_start_addr + GaussianBlurFilter_size - 1;
	//addr_t GaussianBlurFilter_RS_start_addr = 0x74000000;
	//addr_t GaussianBlurFilter_RS_size = 0x01000000;
	//addr_t GaussianBlurFilter_RS_end_addr = GaussianBlurFilter_RS_start_addr + GaussianBlurFilter_RS_size - 1;
	...
	void parse(int argc, char **argv) override {
		...
		assert((mem_end_addr < clint_start_addr || mem_start_addr > GaussianBlurFilter_end_addr) &&
...
int sc_main(int argc, char **argv) {
	...
	GaussianBlurFilter GaussianBlurFilter("GaussianBlurFilter");
	//GaussianBlurFilter_RS GaussianBlurFilter_rs("GaussianBlurFilter_rs");
	...
	bus.ports[12] = new PortMapping(opt.GaussianBlurFilter_start_addr, opt.GaussianBlurFilter_end_addr);
	//bus.ports[13] = new PortMapping(opt.GaussianBlurFilter_RS_start_addr, opt.GaussianBlurFilter_RS_end_addr);
	...
	bus.isocks[12].bind(GaussianBlurFilter.tsock);
	//bus.isocks[13].bind(GaussianBlurFilter_rs.tsock);
